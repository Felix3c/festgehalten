...
- Rechtsform: Vorlage liegt in ~/kybernokratie/RECHTSFORM.md (Empfehlung gUG jetzt). Fünf Häkchen am Ende der Vorlage setzen, dann Satzungsentwurf. Fragen für die Anwaltsstunde nach dem 11.09. stehen drin.
...
- Regel für `verfall_am` festlegen (Vorschlag: zwei Jahre nach Prüfdatum, als Halter-Regel in jede BUCH.md), dann für die offenen Wetten nachtragen.
