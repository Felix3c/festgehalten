...
Auf GitHub ein neues, öffentliches Repository anlegen (ohne README), dann:
...
Im Repository unter **Settings → Pages → Source** „GitHub Actions" wählen. Der
Workflow aus dem Gerüst baut die Seite bei jedem Push; nach ein bis zwei Minuten steht
sie unter `https://DEIN-NAME.github.io/meinbuch/`.
